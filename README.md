...
### מה כלול בפרויקט
- **Tasks** — קוד צד השרת לניהול משימות:
...
- **Algorithms** — מימוש הפונקציה למציאת תתי‑הרצפים העולים
- **Design** — תשובות ועיצוב למחלקות REST והזמנות/תשלומים
- **ANSWERS.docx** — מסמך מסכם עם תשובות
- קבצים נוספים: `.idea`, `out/production` (תוצרי בנייה)
